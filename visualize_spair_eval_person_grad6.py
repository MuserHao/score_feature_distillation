...
def main(args):
    ...
    cat_list = ['person']
    args.plot_path = args.plot_path + '_' + args.repeat_direc
    args.save_path = args.save_path + '_' + args.repeat_direc
    ...
    evaluator.set_repeat_direc(args.repeat_direc)
    # t_values = [0]
    for t in tqdm(t_values):
        evaluator.set_t(t)
        # print(f'start evaluation2')
        # Evaluate using the SpairEvaluator
        res = evaluator.evaluate_person_grad6()
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_path', type=str, default='./temp_features/spair_ft_person_grad6v2', help='path to save features')
    ...
    parser.add_argument('--plot_path', type=str, default='./plot_res/plots_person_grad6v2', help='path to save plots')
    parser.add_argument('--repeat_direc', type=str, default='bs', choices=['bs', 'ch'])
    args = parser.parse_args()
    main(args)

"""
The feature used for computing performance is the gradient of the feature map to z
"""
...
def main(args):
    ...
    for t in tqdm(t_values):
        ...
        res = evaluator.evaluate_person_grad2()
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_path', type=str, default='./temp_features/spair_ft_person_grad2', help='path to save features')
    ...
    parser.add_argument('--plot_path', type=str, default='./plot_res/plots_person_grad2', help='path to save plots')

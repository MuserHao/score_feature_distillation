        ...
        for extrap_coef in extrap_coefs:
            for time_interval in time_intervals:
                ...
                for t in tqdm(t_values):
                    ...
                    point_metric_dict, image_metric_dict = evaluator.evaluate_person_diff2()
                    for cat in cat_list:
                ...
                for cat in cat_list:
                    ...
                    plt.legend()
                    plt.savefig(os.path.join(args.plot_path, f'{cat}' f'{cat}_evaluation_curve_{args.threshold}_{time_diff}_{extrap_coef}_{time_interval}.png'))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_path', type=str, default='/scratch/lt453/spair_ft_person_diff2/', help='path to save features')
    ...
    parser.add_argument('--plot_path', type=str, default='./plots_person_diff2', help='path to save plots')

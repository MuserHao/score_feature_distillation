...
def main(args):
    ...
    args.plot_path = f'./plot_res/plots_{args.cls_name}_grad4'
    args.save_path = f'./temp_features/spair_ft_{args.cls_name}_grad4'
    ...
    for t in tqdm(t_values):
        ...
        res = evaluator.evaluate_person_grad4(cls_name=cat_list, path='/media/data2/shilei/score_feature_distillation')

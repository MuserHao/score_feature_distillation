...
def main(args):
    ...
    print(args.t_range[0], args.t_range[1])
    ...
    for t in tqdm(t_values):
        ...
        res = evaluator.evaluate_person_grad5()
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_path', type=str, default='./temp_features/spair_ft_person_grad5', help='path to save features')
    ...
    parser.add_argument('--plot_path', type=str, default='./plot_res/plots_person_grad5', help='path to save plots')
